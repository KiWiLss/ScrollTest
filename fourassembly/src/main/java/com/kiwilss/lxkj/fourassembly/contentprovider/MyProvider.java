...
public class MyProvider extends ContentProvider {
    ...
    public Cursor query( @NonNull Uri uri,  @Nullable String[] strings,
        ...
        switch (uriMatcher.match(uri)) {
            case TABLE1_DIR://查询 table1 表中所有数据
                break;
            case TABLE1_ITEM://查询 table1 表中单条数据
                break;
            case TABLE2_DIR://查询 table2 表中所有数据
                break;
            case TABLE2_ITEM://查询 table2 表中单条数据
                break;
        }
        return null;
    }
    ...
    //@androidx.annotation.NullableU r i M a t c h e r
    @Nullable
    @Override
